...
var _reactContenteditable = _interopRequireDefault(
	...
	(function (_React$Component) {
		...
		function EditablePopup(props) {
			...
			_this = _possibleConstructorReturn(
				this,
				_getPrototypeOf(EditablePopup).call(this, props)
			);

			_defineProperty(
				_assertThisInitialized(_this),
				'parsedChildren',
				_this.props.children.$$typeof
					? _server['default'].renderToStaticMarkup(_this.props.children)
		...
		_createClass(EditablePopup, [
			{
				...
				value: function componentDidMount() {
					...
					if (this.props.v2) {
						...
						this.setState({
							nametag:
								this.props.nametag || this.thePopup._source.nametag,
						});
					}
				},
			},
				...
				value: function render() {
					...
					var contentScreen =
						...
						_react['default'].createElement(
							...
							null,
							(0, _htmlReactParser['default'])(this.state.content),
							Buttons
						);
